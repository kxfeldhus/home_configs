...
au BufNewFile,BufRead httpd.conf*,srm.conf*,access.conf*,apache.conf*,apache2.conf*,/etc/httpd/conf.d/*.conf*,auth_mysql.conf*,auth_pgsql.conf*,ssl.conf*,perl.conf*,php.conf*,python.conf*,squirrelmail.conf* call s:StarSetf('apache')
...
" More Apache files.
au BufNewFile,BufRead /etc/httpd/conf.*/*,/etc/httpd/sites-*/*,/etc/httpd/mods-*/*		call s:StarSetf('apache')
